...
public class Sanctity extends LightAbility implements AddonAbility {
	...
	public void setFields() {
		this.cooldown = ConfigManager.getConfig().getLong("ExtraAbilities.Spirits.Sanctity.Cooldown");
		this.healeffect = ConfigManager.getConfig().getInt("ExtraAbilities.Spirits.Sanctity.Power");
		this.duration = ConfigManager.getConfig().getInt("ExtraAbilities.Spirits.Sanctity.Duration");
		this.chargeTime = ConfigManager.getConfig().getLong("ExtraAbilities.Spirits.Sanctity.ChargeTime");
